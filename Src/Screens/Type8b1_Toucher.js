...
export default class Type8b1_Toucher extends React.Component {
...
<View style={styles.container2}>
  ...
  <Text style={styles.t4} >Vous n'appuyez pas assez longtemps sans bouger, réésayez avec un toucher
